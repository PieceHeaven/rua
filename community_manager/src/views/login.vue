        ...
        <div class="regiser" v-if="!login">
          <Card>
            ...
            <Row style="margin-top: 0">
              <Col :span="5">
                <span style="line-height: 50px;">用户名:</span>
              </Col>
              <Col :span="18">
                <Input prefix="ios-at" size="large" placeholder="用户名" v-model="name" style="width: auto;width:100%;" />
              </Col>
            </Row>
            <Row style="margin-top: 0">
              <Col :span="5">
                <span style="line-height: 50px;">用户头像:</span>
              </Col>
              <Col :span="18">
                <Upload action="http://localhost:8089/login/upload" 
  ...
  methods: {
    async sendCode() {
      ...
      if (reg.test(email)) {
        ...
        const {
          data: { code, mailCode, msg }
        } = result;
        if (code == 0) {
          this.$Message.success(msg);
          this.visCode = mailCode;
